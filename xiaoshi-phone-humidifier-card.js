      ...
      <div class="card-config">
        ...
        <div class="row">
          ...
          ${(this.config.buttons || []).map((button, index) => html`
            ...
            ></ha-entity-picker>
          `)}
          ${(!this.config.buttons || this.config.buttons.length < 5) ? html`
...
export class XiaoshiPhoneHumidifierCard extends LitElement {
  ...
  render() {
    ...
    if (state === 'on') statusColor = 'rgb(33,150,243)';
            ...
            <div class="content-container">
                ...
                <div class="status-area" style="color: ${fgColor}">${translatedState}：
                    <div class="humidifier-adjust-container">
                        ...
                        <div class="humidifier-display">${humidity}</div>
